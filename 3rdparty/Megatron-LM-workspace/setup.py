...
# Path for the C++ extension's source file (submodule checkout lives under Megatron-LM/)
megatron_core_cpp_extension_source_file = os.path.join(
    "Megatron-LM", "megatron", "core", "datasets", "helpers.cpp"
)
